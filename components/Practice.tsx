...
const PRACTICES = [
  ...
  {
    id: "tax", num: "02", name: "Tax Litigation & Advisory",
  ...
  {
    id: "civil", num: "03", name: "Civil & Commercial Disputes",
  ...
  {
    id: "wcc", num: "04", name: "White Collar Crimes & Investigations",
  ...
  {
    id: "tech", num: "06", name: "Technology Law",

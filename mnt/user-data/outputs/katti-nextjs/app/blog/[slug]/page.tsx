...
const ptComponents: PortableTextComponents = {
  block: {
    normal:     ({ children }) => <p style={{ marginBottom: "1.1rem" }}>{children}</p>,
    ...
    h3:         ({ children }) => <h3 style={{ fontFamily: "var(--font-cinzel)", fontSize: ".8rem", letterSpacing: ".08em", color: "var(--gold)", margin: "1.3rem 0 .5rem" }}>{children}</h3>,
  ...
  marks: {
    ...
    code:   ({ children }) => <code style={{ background: "rgba(201,166,64,.1)", padding: "1px 5px", fontSize: ".85em", borderRadius: 3 }}>{children}</code>,
    link:   ({ value, children }) => (
